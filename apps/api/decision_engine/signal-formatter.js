...
export function buildHomeViewModel(signal) {
  ...
  const flowSummary = {
    ...
    call_premium_fmt:           fb.call_premium_abs != null ? '+' + (fb.call_premium_abs / 1e6).toFixed(1) + 'M' : '--',
    put_premium_fmt:            fb.put_premium_abs  != null ? '+' + (fb.put_premium_abs  / 1e6).toFixed(1) + 'M' : '--',
    net_premium_fmt:            fb.net_premium_millions != null ? (fb.net_premium_millions >= 0 ? '+' : '') + fb.net_premium_millions.toFixed(1) + 'M' : '--',
